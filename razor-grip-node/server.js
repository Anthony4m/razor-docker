...
dotenv.config()
const uri = `mongodb+srv://Amoah4m:Iamanthony1234@razorgrip.ypazk.mongodb.net/razorgrip?retryWrites=true&w=majority`;
        ...
        recipients.forEach(recipient => {
            ...
            chat.save()
                .then((result) => {
                    ...
                    // console.log(result.sender, result.text, time)
                })
                .catch((err) => {
                    console.log(err)
                })
